...
Begin VB.Form FrmAdmProductividad 
   Caption         =   "Administración de "
   ClientHeight    =   5400
   ClientLeft      =   705
   ClientTop       =   1170
   ClientWidth     =   8790
   Icon            =   "FrmAdmProductividad.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread spr 
         Height          =   2940
         Left            =   105
         OleObjectBlob   =   "FrmAdmProductividad.frx":0442
         TabIndex        =   10
         Top             =   780
         Width           =   8190
      End
      Begin VB.Frame frBot 
         ...
         Begin VB.CommandButton botHelpProd 
            Height          =   315
            Left            =   7650
            Picture         =   "FrmAdmProductividad.frx":080F
            Style           =   1  'Graphical
            TabIndex        =   8
   ...
   Begin ComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         ...
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmProductividad.frx":0911
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmProductividad.frx":0C2B
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmProductividad.frx":0F45
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmProductividad.frx":125F
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmProductividad.frx":1579
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmProductividad.frx":1893
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmProductividad.frx":1BAD
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmProductividad.frx":1EC7
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmProductividad.frx":21E1
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmProductividad.frx":24FB
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmProductividad.frx":260D
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmProductividad.frx":271F
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmProductividad.frx":2CC1
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmProductividad.frx":34F3
            Key             =   ""
         EndProperty
         BeginProperty ListImage15 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmProductividad.frx":3CB1
            Key             =   ""
         EndProperty
         BeginProperty ListImage16 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmProductividad.frx":4573
            Key             =   ""
         EndProperty
         BeginProperty ListImage17 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmProductividad.frx":488D
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "FrmAdmProductividad"
...
Public Sub Altas()
    ...
    Modo = "ALTA"
    FrmAdmProductividad.caption = "Productividad  -Altas- "
End Sub
Private Sub L_AltasDatos()

If L_TodoCargado Then
    FrmAdmProductividad.caption = Aplicacion.SeteoProceso(FrmAdmProductividad.caption)

    Aplicacion.ComienzoTrans

    MeLlenarObjeto

    If cl_Productividad.Insertar_Porductividad() Then
    ...
    FrmAdmProductividad.caption = Aplicacion.SeteoFin
...
Modo = "MOD"
FrmAdmProductividad.caption = "Productividad  -Modificacion y Bajas- "
...
If cl_Productividad.Update_Productividad Then
    Aplicacion.TerminarConExitoTrans
    SeteoBotonesMod True
...
sqlGral$ = ""
sqlGral$ = sql$ & " SELECT aniomes, fch_desde,fch_hasta,c.cod_prod,descrip,multiplo " _
& " FROM estadis.codigos_productividad c , baires.producto p" _
...
If cl_Productividad.Delete_Productividad Then
    Aplicacion.TerminarConExitoTrans
    SeteoBotonesMod True
...
If Not RS.EOF Then
    ...
    Do While Not RS.EOF
        ...
        spr.SetText 5, spr.MaxRows, Trim(RS!multiplo)
        RS.MoveNext
    Loop
End If
