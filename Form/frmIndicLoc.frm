...
Begin VB.Form frmIndicLoc 
   ...
   Begin TabDlg.SSTab tabEspigon 
      ...
      Tab(2).Control(0)=   "botExcelB"
      Tab(2).Control(0).Enabled=   -1  'True
      Tab(2).Control(1)=   "tabLocB"
      ...
      Begin TabDlg.SSTab TabLocI 
         ...
         TabCaption(6)   =   "L19 CORD"
         TabPicture(6)   =   "frmIndicLoc.frx":06C6
         Tab(6).ControlCount=   1
         Tab(6).ControlEnabled=   0   'False
         Tab(6).Control(0)=   "sprInt(6)"
         Tab(6).Control(0).Enabled=   0   'False
         Begin FPSpread.vaSpread sprInt 
            Height          =   2655
            Index           =   5
            Left            =   -74595
            OleObjectBlob   =   "frmIndicLoc.frx":06E2
            TabIndex        =   54
            Top             =   405
            Width           =   6375
         End
         Begin FPSpread.vaSpread sprInt 
            ...
            Index           =   4
            Left            =   -74610
            OleObjectBlob   =   "frmIndicLoc.frx":0C0F
            TabIndex        =   53
            Top             =   450
            Width           =   6375
         End
         Begin FPSpread.vaSpread sprInt 
            ...
            Index           =   3
            Left            =   -74640
            OleObjectBlob   =   "frmIndicLoc.frx":113C
            TabIndex        =   52
            Top             =   420
            Width           =   6375
         End
         Begin FPSpread.vaSpread sprInt 
            ...
            Index           =   2
            Left            =   -74565
            OleObjectBlob   =   "frmIndicLoc.frx":1669
            TabIndex        =   51
            Top             =   450
            Width           =   6375
         End
         Begin FPSpread.vaSpread sprInt 
            ...
            Index           =   1
            Left            =   -74595
            OleObjectBlob   =   "frmIndicLoc.frx":1B96
            TabIndex        =   50
            Top             =   420
            Width           =   6375
         End
         Begin FPSpread.vaSpread sprInt 
            ...
            Index           =   0
            Left            =   435
            OleObjectBlob   =   "frmIndicLoc.frx":20C3
            TabIndex        =   49
            Top             =   435
            Width           =   6375
         End
         Begin FPSpread.vaSpread sprInt 
            ...
            Index           =   6
            Left            =   -74580
            OleObjectBlob   =   "frmIndicLoc.frx":25F0
            TabIndex        =   55
            Top             =   450
            Width           =   6375
         End
      ...
      Begin TabDlg.SSTab tabLocA 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         TabCaption(0)   =   "L. Lleg. (5)"
         TabPicture(0)   =   "frmIndicLoc.frx":3BD3
         Tab(0).ControlCount=   1
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "sprEzeA(0)"
         Tab(0).Control(0).Enabled=   0   'False
         TabCaption(1)   =   "L Lleg. (6)"
         TabPicture(1)   =   "frmIndicLoc.frx":3BEF
         Tab(1).ControlCount=   1
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "sprEzeA(1)"
         Tab(1).Control(0).Enabled=   0   'False
         TabCaption(2)   =   "L Sal (22)"
         TabPicture(2)   =   "frmIndicLoc.frx":3C0B
         Tab(2).ControlCount=   1
         Tab(2).ControlEnabled=   0   'False
         Tab(2).Control(0)=   "sprEzeA(2)"
         Tab(2).Control(0).Enabled=   0   'False
         TabCaption(3)   =   "L08"
         TabPicture(3)   =   "frmIndicLoc.frx":3C27
         Tab(3).ControlCount=   1
         Tab(3).ControlEnabled=   0   'False
         ...
         Begin FPSpread.vaSpread sprEzeA 
            ...
            Index           =   0
            Left            =   120
            OleObjectBlob   =   "frmIndicLoc.frx":3C43
            TabIndex        =   24
            Top             =   405
            Width           =   6375
         End
         Begin FPSpread.vaSpread sprEzeA 
            ...
            Index           =   1
            Left            =   -74880
            OleObjectBlob   =   "frmIndicLoc.frx":4170
            TabIndex        =   25
            Top             =   390
            Width           =   6375
         End
         Begin FPSpread.vaSpread sprEzeA 
            ...
            Index           =   2
            Left            =   -74880
            OleObjectBlob   =   "frmIndicLoc.frx":469D
            TabIndex        =   26
            Top             =   405
            Width           =   6375
         End
         Begin FPSpread.vaSpread sprEzeA 
            ...
            Index           =   3
            Left            =   -74880
            OleObjectBlob   =   "frmIndicLoc.frx":4BCA
            TabIndex        =   27
            Top             =   405
            Width           =   6375
         End
      ...
      Begin TabDlg.SSTab tabLocB 
         ...
         EndProperty
         TabCaption(0)   =   "L01"
         TabPicture(0)   =   "frmIndicLoc.frx":50F7
         Tab(0).ControlCount=   1
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "sprEzeB(0)"
         Tab(0).Control(0).Enabled=   0   'False
         TabCaption(1)   =   "L02"
         TabPicture(1)   =   "frmIndicLoc.frx":5113
         Tab(1).ControlCount=   1
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "sprEzeB(1)"
         Tab(1).Control(0).Enabled=   0   'False
         TabCaption(2)   =   "L03"
         TabPicture(2)   =   "frmIndicLoc.frx":512F
         Tab(2).ControlCount=   1
         Tab(2).ControlEnabled=   0   'False
         ...
         Begin FPSpread.vaSpread sprEzeB 
            ...
            Index           =   2
            Left            =   -74850
            OleObjectBlob   =   "frmIndicLoc.frx":514B
            TabIndex        =   34
            Top             =   420
            Width           =   6375
         End
         Begin FPSpread.vaSpread sprEzeB 
            ...
            Index           =   1
            Left            =   -74850
            OleObjectBlob   =   "frmIndicLoc.frx":5678
            TabIndex        =   33
            Top             =   405
            Width           =   6375
         End
         Begin FPSpread.vaSpread sprEzeA 
            ...
            Index           =   4
            Left            =   -74880
            OleObjectBlob   =   "frmIndicLoc.frx":5BA5
            TabIndex        =   29
            Top             =   405
            Width           =   6375
         End
         Begin FPSpread.vaSpread sprEzeA 
            ...
            Index           =   5
            Left            =   -74880
            OleObjectBlob   =   "frmIndicLoc.frx":60D2
            TabIndex        =   30
            Top             =   405
            Width           =   6375
         End
         Begin FPSpread.vaSpread sprEzeA 
            ...
            Index           =   6
            Left            =   -74880
            OleObjectBlob   =   "frmIndicLoc.frx":65FF
            TabIndex        =   31
            Top             =   390
            Width           =   6375
         End
         Begin FPSpread.vaSpread sprEzeB 
            ...
            Index           =   0
            Left            =   120
            OleObjectBlob   =   "frmIndicLoc.frx":6B2C
            TabIndex        =   32
            Top             =   405
            Width           =   6375
         End
      ...
      Begin TabDlg.SSTab tabLocE 
         ...
         EndProperty
         TabCaption(0)   =   "L09"
         TabPicture(0)   =   "frmIndicLoc.frx":7059
         Tab(0).ControlCount=   1
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "sprAep(0)"
         Tab(0).Control(0).Enabled=   0   'False
         TabCaption(1)   =   "L14"
         TabPicture(1)   =   "frmIndicLoc.frx":7075
         Tab(1).ControlCount=   1
         Tab(1).ControlEnabled=   0   'False
         ...
         Begin FPSpread.vaSpread sprAep 
            ...
            Index           =   1
            Left            =   -74880
            OleObjectBlob   =   "frmIndicLoc.frx":7091
            TabIndex        =   42
            Top             =   405
            Width           =   6375
         End
         Begin FPSpread.vaSpread sprAep 
            ...
            Index           =   0
            Left            =   120
            OleObjectBlob   =   "frmIndicLoc.frx":75BE
            TabIndex        =   41
            Top             =   405
            Width           =   6375
         End
         Begin FPSpread.vaSpread sprEzeA 
            ...
            Index           =   9
            Left            =   -74880
            OleObjectBlob   =   "frmIndicLoc.frx":7AEB
            TabIndex        =   40
            Top             =   390
            Width           =   6375
         End
         Begin FPSpread.vaSpread sprEzeA 
            ...
            Index           =   8
            Left            =   -74880
            OleObjectBlob   =   "frmIndicLoc.frx":8018
            TabIndex        =   39
            Top             =   405
            Width           =   6375
         End
         Begin FPSpread.vaSpread sprEzeA 
            ...
            Index           =   7
            Left            =   -74880
            OleObjectBlob   =   "frmIndicLoc.frx":8545
            TabIndex        =   38
            Top             =   405
            Width           =   6375
         End
         Begin FPSpread.vaSpread sprEzeB 
            ...
            Index           =   4
            Left            =   -74850
            OleObjectBlob   =   "frmIndicLoc.frx":8A72
            TabIndex        =   37
            Top             =   405
            Width           =   6375
         End
         Begin FPSpread.vaSpread sprEzeB 
            ...
            Index           =   3
            Left            =   -74850
            OleObjectBlob   =   "frmIndicLoc.frx":8F9F
            TabIndex        =   36
            Top             =   420
            Width           =   6375
         End
...
sql = sql & "group by cod_depn,cod_sdep,decode(cod_local,'L21', decode(cod_sloc,0,'L05','L06'),'L07','L22',cod_local)"
...
sqlX = sqlX & "group by cod_depn,cod_sdep,decode(cod_local,'L21', decode(cod_sloc,0,'L05','L06'),'L07','L22',cod_local) "
...
For fila = 1 To 6
    ...
    For i = 0 To 6
        ...
        Spread.spread_ResaltarCelda sprInt(i), 5, fila
    Next
Next
End Sub
    ...
    Select Case RsData!cod_depn
        ...
        Case DSLoc(2).Dep
            Select Case RsData!Cod_Sdep
                Case DSLoc(2).Sdep
                    Select Case RsData!cod_local
                        ...
                        Case Left(DSLoc(2).locales(5), 3)  '3
                        ...
                        Case Left(DSLoc(2).locales(7), 3)  '5
            ...
            Select Case RsData!cod_local
                ...
                Case Left(DSLoc(4).locales(2), 3)
                    L_PonerenGrilla sprInt(6), "Facturación", str(RsData!imp)
                    L_PonerenGrilla sprInt(6), "Tickets", str(RsData!cant_t)
                    L_PonerenGrilla sprInt(6), "Pr. x Tickets", str(RsData!imp / RsData!cant_t)
    ...
    Select Case RsDataAnt!cod_depn
      ...
      Case DSLoc(4).Dep
            Select Case RsDataAnt!cod_local
                ...
                Case Left(DSLoc(4).locales(2), 3)
                    sprInt(6).SetText 3, 1, str(RsDataAnt!imp)
                    sprInt(6).SetText 3, 2, str(RsDataAnt!cant_t)
                    sprInt(6).SetText 3, 3, str(RsDataAnt!imp / RsDataAnt!cant_t)
                Case Left(DSLoc(5).locales(1), 3)
...
Private Function L_TratarVolados()
Dim sql As String
...
If Aplicacion.ObtenerRsDAO(sql, rs_pax) Then
    ...
    If CDate(FH) <= CDate(rs_pax!fch) Then
        ...
        sql = sql & " cod_depn,"
        sql = sql & " cod_sdep,"
        sql = sql & " DECODE(local,'L08','L22','L07','L22',LOCAL) LOCAL,"
    ...
    Select Case RsDataVol!cod_depn
       ...
       Case DSLoc(4).Dep
            Select Case RsDataVol!local
                ...
                Case Left(DSLoc(4).locales(2), 3)
                    sprInt(6).MaxRows = sprInt(6).MaxRows + 1
                    sprInt(6).SetText 1, sprInt(6).MaxRows, "Pax Viajados"
                    sprInt(6).SetText 2, 4, str(RsDataVol!cant_v)
                    
                    sprInt(6).MaxRows = sprInt(6).MaxRows + 1
                    sprInt(6).SetText 1, sprInt(6).MaxRows, "Pr x Pax Viaj." '
                
                    sprInt(6).MaxRows = sprInt(6).MaxRows + 1
                    sprInt(6).SetText 1, sprInt(6).MaxRows, "Captación"
                    If RsDataVol!cant_v > 0 Then
                       sprInt(6).GetText 2, 1, valor
                       sprInt(6).SetText 2, 5, str(valor / RsDataVol!cant_v)
                       sprInt(6).GetText 2, 2, valor
                       sprInt(6).SetText 2, 6, Format$((valor / RsDataVol!cant_v * 100), "00.00")
                    End If
    ...
    Select Case RsDataVol!cod_depn
       ...
       Case DSLoc(4).Dep
            Select Case RsDataVol!local
                ...
                Case Left(DSLoc(4).locales(2), 3)
                    sprInt(6).SetText 3, 4, str(RsDataVol!cant_v)
                    If RsDataVol!cant_v > 0 Then
                       sprInt(6).GetText 3, 1, valor
                       sprInt(6).SetText 3, 5, str(valor / RsDataVol!cant_v)
                       sprInt(6).GetText 3, 2, valor
                       sprInt(6).SetText 3, 6, Format$((valor / RsDataVol!cant_v * 100), "00.00")
                    End If
...
End If
        ...
        sql = sql & "cod_depn,"
        sql = sql & "cod_sdep,"
        sql = sql & "decode(local,'L07','L22','L08','L22',LOCAL) LOCAL,"
        sql = sql & " SUM(pax_volados.cantidad) CANT_V "
        sql = sql & " From estadis.pax_volados "
        sql = sql & " Where "
        sql = sql & " fch_vuelo Between " & func_ToDate(FD) & " AND " & func_ToDate(FH)
        sql = sql & " GROUP BY COD_DEPN,COD_SDEP,decode(local,'L07','L22','L08','L22',LOCAL) "
