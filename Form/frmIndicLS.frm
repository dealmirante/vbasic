...
Begin VB.Form frmIndicLS 
   ...
   Begin TabDlg.SSTab tabEspigon 
      ...
      TabPicture(0)   =   "frmIndicLS.frx":0000
      ...
      TabPicture(1)   =   "frmIndicLS.frx":001C
      ...
      TabPicture(2)   =   "frmIndicLS.frx":0038
      ...
      Tab(2).Control(2)=   "Label2(5)"
      Tab(2).Control(2).Enabled=   0   'False
      Tab(2).Control(3)=   "Label2(4)"
      Tab(2).Control(3).Enabled=   0   'False
      TabCaption(3)   =   "AEROP."
      TabPicture(3)   =   "frmIndicLS.frx":0054
      ...
      Tab(3).Control(3)=   "Label2(6)"
      Tab(3).Control(3).Enabled=   0   'False
      Begin FPSpread.vaSpread sprAEP 
         Height          =   3045
         Left            =   -74865
         OleObjectBlob   =   "frmIndicLS.frx":0070
         TabIndex        =   37
         Top             =   585
         Width           =   7830
      End
      Begin FPSpread.vaSpread sprEZEB 
         Height          =   3045
         Left            =   -74850
         OleObjectBlob   =   "frmIndicLS.frx":0840
         TabIndex        =   34
         Top             =   600
         Width           =   7800
      End
      Begin FPSpread.vaSpread sprEZEA 
         Height          =   3045
         Left            =   -74835
         OleObjectBlob   =   "frmIndicLS.frx":1010
         TabIndex        =   31
         Top             =   570
         Width           =   7830
      End
      Begin FPSpread.vaSpread sprTotal 
         Height          =   3045
         Left            =   180
         OleObjectBlob   =   "frmIndicLS.frx":17E0
         TabIndex        =   16
         Top             =   570
         Width           =   7800
      End
...
If AepTickS > 0 Then
    SprAep.SetText 2, SprAep.MaxRows, Format$(str(AepImpS / AepTickS), "##.##")
    SprAep.SetText 6, SprAep.MaxRows, Format$(str(AepImpL / AepTickL), "##.##")
End If
...
If IntaTickS > 0 Then
SprEzeA.SetText 2, SprEzeA.MaxRows, Format$(str(IntaImpS / IntaTickS), "##.##")
SprEzeA.SetText 6, SprEzeA.MaxRows, Format$(str(IntaImpL / IntaTickL), "##.##")
End If
...
SprEzeB.SetText 6, SprEzeB.MaxRows, Format$(str(IntbImpL / IntbTickL), "##.##")
End If
...
SprAep.SetText 3, 3, Format$(str(AepImpS / AepTickS), "##.##")
SprAep.SetText 7, 3, Format$(str(AepImpL / AepTickL), "##.##")
...
SprEzeA.SetText 3, 3, Format$(str(IntaImpS / IntaTickS), "##.##")
SprEzeA.SetText 7, 3, Format$(str(IntaImpL / IntaTickL), "##.##")
...
SprEzeB.SetText 7, 3, Format$(str(IntbImpL / IntbTickL), "##.##")
                    ...
                    Case DSLoc(3).Sdep
                        ...
                        Else
                            ...
                            If RsDataVol!cant_v > 0 Then
                                ...
                                SprEzeB.SetText col + 4, 5, str(valor / RsDataVol!cant_v)
...
SQL = " SELECT "
SQL = SQL & " PL.cod_depn, "
SQL = SQL & " PL.cod_sdep, LT.TRANCITO, "
...
SQL = SQL & "group by PL.cod_depn,PL.cod_sdep,LT.TRANCITO,LT.TIPO_VUELO "
...
SQL = SQL & "group by PL.cod_depn,PL.cod_sdep,LT.TRANCITO,LT.TIPO_VUELO, mod(pl.cod_vuelo,2) "


sqlX = " SELECT "
sqlX = sqlX & " PL.cod_depn, "
sqlX = sqlX & " PL.cod_sdep, LT.TRANCITO, "
...
sqlX = sqlX & "group by PL.cod_depn,PL.cod_sdep,LT.TRANCITO,LT.TIPO_VUELO "
...
sqlX = sqlX & "group by PL.cod_depn,PL.cod_sdep,LT.TRANCITO,LT.TIPO_VUELO, mod(pl.cod_vuelo,2) "
