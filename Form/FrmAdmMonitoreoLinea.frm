...
Begin VB.Form FrmAdmMonitoreoLinea 
   Caption         =   "Administración de "
   ClientHeight    =   5400
   ClientLeft      =   705
   ClientTop       =   1170
   ClientWidth     =   8550
   Icon            =   "FrmAdmMonitoreoLinea.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin ComctlLib.Toolbar Tollbar 
      ...
      EndProperty
      BorderStyle     =   1
      MouseIcon       =   "FrmAdmMonitoreoLinea.frx":0442
   End
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread spr 
         Height          =   2865
         Left            =   105
         OleObjectBlob   =   "FrmAdmMonitoreoLinea.frx":045E
         TabIndex        =   15
         Top             =   690
         Width           =   7290
      End
      Begin VB.Frame frBot 
         ...
         Begin ComctlLib.Toolbar Toolbar1 
            ...
            EndProperty
            BorderStyle     =   1
            MouseIcon       =   "FrmAdmMonitoreoLinea.frx":079B
         End
         Begin VB.TextBox txtCamino 
            Height          =   300
            Left            =   2850
            TabIndex        =   17
            Top             =   60
         ...
         Begin VB.CommandButton botHelpProd 
            Height          =   315
            Left            =   6810
            Picture         =   "FrmAdmMonitoreoLinea.frx":07B7
            Style           =   1  'Graphical
            TabIndex        =   8
   ...
   Begin ComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         ...
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmMonitoreoLinea.frx":08B9
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmMonitoreoLinea.frx":0BD3
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmMonitoreoLinea.frx":0EED
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmMonitoreoLinea.frx":1207
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmMonitoreoLinea.frx":1521
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmMonitoreoLinea.frx":183B
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmMonitoreoLinea.frx":1B55
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmMonitoreoLinea.frx":1E6F
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmMonitoreoLinea.frx":2189
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmMonitoreoLinea.frx":24A3
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmMonitoreoLinea.frx":25B5
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmMonitoreoLinea.frx":26C7
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmMonitoreoLinea.frx":2C69
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmMonitoreoLinea.frx":349B
            Key             =   ""
         EndProperty
         BeginProperty ListImage15 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmMonitoreoLinea.frx":3C59
            Key             =   ""
         EndProperty
         BeginProperty ListImage16 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmMonitoreoLinea.frx":451B
            Key             =   ""
         EndProperty
         BeginProperty ListImage17 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmAdmMonitoreoLinea.frx":4835
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "FrmAdmMonitoreoLinea"
...
Public Sub altas()
    ...
    Modo = "ALTA"
    FrmAdmMonitoreoLinea.caption = "Lanzamientos  -Altas- "
End Sub
Private Sub L_AltasDatos()

If L_TodoCargado Then
    FrmAdmMonitoreoLinea.caption = Aplicacion.SeteoProceso(FrmAdmMonitoreoLinea.caption)

    Aplicacion.ComienzoTrans

    MeLlenarObjeto

    If cl_Productividad.Insertar_MonLinea() Then
    ...
    FrmAdmMonitoreoLinea.caption = Aplicacion.SeteoFin
...
Modo = "MOD"
FrmAdmMonitoreoLinea.caption = "Lanzamientos  -Modificacion y Bajas- "
...
If cl_Productividad.Update_MonLinea Then
    Aplicacion.TerminarConExitoTrans
    SeteoBotonesMod True
...
sqlGral$ = ""
sqlGral$ = sql$ & " SELECT ANIOMES,L.COD_RUBR,L.COD_PROV,DESCRIP, ESTIMADO_$ Est " _
& " FROM ESTADIS.MONITOREO_LINEA L , BAIRES.PROVRUBR R , BAIRES.PROVEEDOR P " _
& " Where L.COD_RUBR = R.COD_RUBR And L.COD_PROV = R.COD_PROV AND L.COD_PROV = P.COD_PROV " _
& CondConsulta
...
If cl_Productividad.Delete_MonLinea Then
    Aplicacion.TerminarConExitoTrans
    SeteoBotonesMod True
...
For i = 1 To spr.MaxRows
    ...
    If valor <> "" And Spread_FilaOcupada(spr, i) Then
        clProd.CodRubr = valor
        spr.GetText 2, i, valor
        clProd.CodProv = valor
...
For Each clProd In cl_Productividad.col_producto
    If cod.CodProv = clProd.CodProv Then
        Resp = False
        Exit For
    End If
Next
...
If Not rs.EOF Then
    Do While Not rs.EOF
        ...
        spr.SetText 1, spr.MaxRows, Trim(rs!cod_rubr)
        spr.SetText 2, spr.MaxRows, Trim(rs!cod_prov)
        spr.SetText 3, spr.MaxRows, Trim(rs!Descrip)
        spr.SetText 5, spr.MaxRows, str(rs!est)
        rs.MoveNext
    Loop
End If
...
Dim sql As String
    ...
    If spr.MaxRows > 0 Then
       ...
       If frmHelpProd.MuestraHlp(cod, desc, "Proveedor", sql, "") = vbOK Then
          spr.SetText 2, spr.ActiveRow, cod
...
Dim codigo As String, desc As String, rubro As String
Dim i As Integer, cantidad As String

If txtCamino.Text <> "" Then
    Set AppExcel = CreateObject("Excel.application")
    'AppExcel.Visible = True
    Set libroExcel = AppExcel.Workbooks.Open(txtCamino.Text)
    ...
    i = 1
    'spr.MaxRows = 0
    rubro = hojaExcel.Cells(i, 1).Value
    codigo = hojaExcel.Cells(i, 2).Value
    
    cantidad = hojaExcel.Cells(i, 3).Value

    Do While codigo <> ""
        spr.MaxRows = spr.MaxRows + 1
        spr.SetText 1, i + spr.MaxRows, Trim(rubro)
        spr.SetText 2, i + spr.MaxRows, Trim(codigo)
        Func.Func_ObtenerDesc "Select descrip From baires.PROVEEDOR Where cod_proV = '" & codigo & "' ", desc
        spr.SetText 3, i + spr.MaxRows, Trim(desc)
        spr.SetText 5, i + spr.MaxRows, Trim(cantidad)
    ...
    Spread.Spread_TotalesGrillas spr, 2, 3

    AppExcel.Quit
    Set AppExcel = Nothing
Else
    MsgBox "Debe ingresar fuente de datos excel", vbOKOnly, "Atención"
End If
...
cboAnio.ListIndex = Year(Now) - 2004
...
If KeyAscii = 13 And ModoEdit = 1 Then
    ...
    sql = "SELECT descrip "
    sql = sql & " FROM  baires.proveedor "
    sql = sql & " where cod_prov = '" & cod & "' "
...
Private Sub txtCamino_DblClick()
Dim NOMBRE As String

NOMBRE = frmDir.NombreArchivo()

If NOMBRE <> "" Then
    txtCamino.Text = NOMBRE
End If
