...
Begin VB.Form frmVtaLocalRubro 
   Caption         =   "Ventas por Local/Rubro"
   ClientHeight    =   6390
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9705
   ...
   Begin TabDlg.SSTab tabEspigon 
      ...
      TabCaption(5)   =   "% Dif. Particip."
      TabPicture(5)   =   "frmVtasLocalRubro.frx":2742
      Tab(5).ControlCount=   1
      Tab(5).ControlEnabled=   0   'False
      Tab(5).Control(0)=   "sprResDif"
      Tab(5).Control(0).Enabled=   0   'False
      Begin FPSpread.vaSpread sprResDif 
         Height          =   3525
         Left            =   -74700
         OleObjectBlob   =   "frmVtasLocalRubro.frx":275E
         TabIndex        =   95
         Top             =   645
         Width           =   9090
      End
      Begin TabDlg.SSTab TabEzeA 
         ...
         TabPicture(0)   =   "frmVtasLocalRubro.frx":3164
         Tab(0).ControlCount=   1
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "SSTab1"
         Tab(0).Control(0).Enabled=   0   'False
         TabCaption(1)   =   "L Lleg.(5)"
         TabPicture(1)   =   "frmVtasLocalRubro.frx":3180
         Tab(1).ControlCount=   1
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "SSTab2"
         Tab(1).Control(0).Enabled=   0   'False
         TabCaption(2)   =   "L. Lleg.(6)"
         TabPicture(2)   =   "frmVtasLocalRubro.frx":319C
         Tab(2).ControlCount=   1
         Tab(2).ControlEnabled=   0   'False
         Tab(2).Control(0)=   "SSTab3"
         Tab(2).Control(0).Enabled=   0   'False
         TabCaption(3)   =   "L Sal (22)"
         TabPicture(3)   =   "frmVtasLocalRubro.frx":31B8
         Tab(3).ControlCount=   1
         Tab(3).ControlEnabled=   0   'False
         Tab(3).Control(0)=   "SSTab4"
         Tab(3).Control(0).Enabled=   0   'False
         TabCaption(4)   =   "L08"
         TabPicture(4)   =   "frmVtasLocalRubro.frx":31D4
         Tab(4).ControlCount=   1
         Tab(4).ControlEnabled=   0   'False
         ...
         Begin TabDlg.SSTab SSTab1 
            ...
            EndProperty
            TabCaption(0)   =   "IMP"
            TabPicture(0)   =   "frmVtasLocalRubro.frx":31F0
            Tab(0).ControlCount=   1
            Tab(0).ControlEnabled=   -1  'True
            Tab(0).Control(0)=   "SprImpResumen(0)"
            Tab(0).Control(0).Enabled=   0   'False
            TabCaption(1)   =   "UNI"
            TabPicture(1)   =   "frmVtasLocalRubro.frx":320C
            Tab(1).ControlCount=   1
            Tab(1).ControlEnabled=   0   'False
            ...
            Begin FPSpread.vaSpread SprImpResumen 
               ...
               Index           =   0
               Left            =   180
               OleObjectBlob   =   "frmVtasLocalRubro.frx":3228
               TabIndex        =   55
               Top             =   150
               Width           =   8370
            End
            Begin FPSpread.vaSpread SprUnidResumen 
               ...
               Index           =   0
               Left            =   -74835
               OleObjectBlob   =   "frmVtasLocalRubro.frx":374E
               TabIndex        =   59
               Top             =   135
               Width           =   8310
            End
         ...
         Begin TabDlg.SSTab SSTab2 
            ...
            EndProperty
            TabCaption(0)   =   "IMP"
            TabPicture(0)   =   "frmVtasLocalRubro.frx":3C52
            Tab(0).ControlCount=   1
            Tab(0).ControlEnabled=   -1  'True
            Tab(0).Control(0)=   "SprImp(0)"
            Tab(0).Control(0).Enabled=   0   'False
            TabCaption(1)   =   "UNID"
            TabPicture(1)   =   "frmVtasLocalRubro.frx":3C6E
            Tab(1).ControlCount=   1
            Tab(1).ControlEnabled=   0   'False
            ...
            Begin FPSpread.vaSpread SprUnid 
               ...
               Index           =   0
               Left            =   -74850
               OleObjectBlob   =   "frmVtasLocalRubro.frx":3C8A
               TabIndex        =   77
               Top             =   150
               Width           =   8370
            End
            Begin FPSpread.vaSpread SprImp 
               ...
               Index           =   0
               Left            =   150
               OleObjectBlob   =   "frmVtasLocalRubro.frx":41A0
               TabIndex        =   63
               Top             =   135
               Width           =   8385
            End
         ...
         Begin TabDlg.SSTab SSTab3 
            ...
            EndProperty
            TabCaption(0)   =   "IMP"
            TabPicture(0)   =   "frmVtasLocalRubro.frx":46C6
            Tab(0).ControlCount=   1
            Tab(0).ControlEnabled=   -1  'True
            Tab(0).Control(0)=   "SprImp(1)"
            Tab(0).Control(0).Enabled=   0   'False
            TabCaption(1)   =   "UNID"
            TabPicture(1)   =   "frmVtasLocalRubro.frx":46E2
            Tab(1).ControlCount=   1
            Tab(1).ControlEnabled=   0   'False
            ...
            Begin FPSpread.vaSpread SprUnid 
               ...
               Index           =   1
               Left            =   -74880
               OleObjectBlob   =   "frmVtasLocalRubro.frx":46FE
               TabIndex        =   78
               Top             =   135
               Width           =   8400
            End
            Begin FPSpread.vaSpread SprImp 
               ...
               Index           =   1
               Left            =   150
               OleObjectBlob   =   "frmVtasLocalRubro.frx":4C02
               TabIndex        =   64
               Top             =   135
               Width           =   8385
            End
         ...
         Begin TabDlg.SSTab SSTab4 
            ...
            EndProperty
            TabCaption(0)   =   "IMP"
            TabPicture(0)   =   "frmVtasLocalRubro.frx":5128
            Tab(0).ControlCount=   1
            Tab(0).ControlEnabled=   -1  'True
            Tab(0).Control(0)=   "SprImp(2)"
            Tab(0).Control(0).Enabled=   0   'False
            TabCaption(1)   =   "UNID"
            TabPicture(1)   =   "frmVtasLocalRubro.frx":5144
            Tab(1).ControlCount=   1
            Tab(1).ControlEnabled=   0   'False
            ...
            Begin FPSpread.vaSpread SprUnid 
               ...
               Index           =   2
               Left            =   -74850
               OleObjectBlob   =   "frmVtasLocalRubro.frx":5160
               TabIndex        =   79
               Top             =   105
               Width           =   8370
            End
            Begin FPSpread.vaSpread SprImp 
               ...
               Index           =   2
               Left            =   150
               OleObjectBlob   =   "frmVtasLocalRubro.frx":5664
               TabIndex        =   65
               Top             =   120
               Width           =   8385
            End
         ...
         Begin TabDlg.SSTab SSTab5 
            ...
            EndProperty
            TabCaption(0)   =   "IMP"
            TabPicture(0)   =   "frmVtasLocalRubro.frx":5B8A
            Tab(0).ControlCount=   1
            Tab(0).ControlEnabled=   0   'False
            Tab(0).Control(0)=   "SprImp(3)"
            Tab(0).Control(0).Enabled=   0   'False
            TabCaption(1)   =   "UNID"
            TabPicture(1)   =   "frmVtasLocalRubro.frx":5BA6
            Tab(1).ControlCount=   1
            ...
            Begin FPSpread.vaSpread SprImp 
               ...
               Index           =   3
               Left            =   -74865
               OleObjectBlob   =   "frmVtasLocalRubro.frx":60C6
               TabIndex        =   66
               Top             =   120
               Width           =   8400
            End
      ...
      Begin TabDlg.SSTab TabEzeB 
         ...
         EndProperty
         TabCaption(0)   =   "RESUMEN"
         TabPicture(0)   =   "frmVtasLocalRubro.frx":65EC
         Tab(0).ControlCount=   1
         Tab(0).ControlEnabled=   0   'False
         Tab(0).Control(0)=   "SSTab6"
         Tab(0).Control(0).Enabled=   0   'False
         TabCaption(1)   =   "L01"
         TabPicture(1)   =   "frmVtasLocalRubro.frx":6608
         Tab(1).ControlCount=   1
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "SSTab19"
         Tab(1).Control(0).Enabled=   0   'False
         TabCaption(2)   =   "L02"
         TabPicture(2)   =   "frmVtasLocalRubro.frx":6624
         Tab(2).ControlCount=   1
         Tab(2).ControlEnabled=   0   'False
         Tab(2).Control(0)=   "SSTab8"
         Tab(2).Control(0).Enabled=   0   'False
         TabCaption(3)   =   "L03"
         TabPicture(3)   =   "frmVtasLocalRubro.frx":6640
         Tab(3).ControlCount=   1
         ...
         Begin FPSpread.vaSpread SSTab14 
            ...
            Index           =   5
            Left            =   -74505
            OleObjectBlob   =   "frmVtasLocalRubro.frx":665C
            TabIndex        =   27
            Top             =   105
            Width           =   5505
         End
         Begin FPSpread.vaSpread SSTab7 
            ...
            Index           =   4
            Left            =   -74505
            OleObjectBlob   =   "frmVtasLocalRubro.frx":69B3
            TabIndex        =   26
            Top             =   105
            Width           =   5505
         End
         Begin TabDlg.SSTab SSTab6 
            ...
            EndProperty
            TabCaption(0)   =   "IMP"
            TabPicture(0)   =   "frmVtasLocalRubro.frx":6D26
            Tab(0).ControlCount=   1
            Tab(0).ControlEnabled=   -1  'True
            Tab(0).Control(0)=   "SprImpResumen(1)"
            Tab(0).Control(0).Enabled=   0   'False
            TabCaption(1)   =   "UNID"
            TabPicture(1)   =   "frmVtasLocalRubro.frx":6D42
            Tab(1).ControlCount=   1
            Tab(1).ControlEnabled=   0   'False
            ...
            Begin FPSpread.vaSpread SprImpResumen 
               ...
               Index           =   1
               Left            =   135
               OleObjectBlob   =   "frmVtasLocalRubro.frx":6D5E
               TabIndex        =   56
               Top             =   135
               Width           =   8370
            End
            Begin FPSpread.vaSpread SprUnidResumen 
               ...
               Index           =   1
               Left            =   -74835
               OleObjectBlob   =   "frmVtasLocalRubro.frx":7284
               TabIndex        =   60
               Top             =   195
               Width           =   8370
            End
         ...
         Begin TabDlg.SSTab SSTab8 
            ...
            EndProperty
            TabCaption(0)   =   "IMP"
            TabPicture(0)   =   "frmVtasLocalRubro.frx":7788
            Tab(0).ControlCount=   1
            Tab(0).ControlEnabled=   -1  'True
            Tab(0).Control(0)=   "SprImp(5)"
            Tab(0).Control(0).Enabled=   0   'False
            TabCaption(1)   =   "UNID"
            TabPicture(1)   =   "frmVtasLocalRubro.frx":77A4
            Tab(1).ControlCount=   1
            Tab(1).ControlEnabled=   0   'False
            ...
            Begin FPSpread.vaSpread SprUnid 
               ...
               Index           =   5
               Left            =   -74865
               OleObjectBlob   =   "frmVtasLocalRubro.frx":77C0
               TabIndex        =   82
               Top             =   135
               Width           =   8370
            End
            Begin FPSpread.vaSpread SprImp 
               ...
               Index           =   5
               Left            =   150
               OleObjectBlob   =   "frmVtasLocalRubro.frx":7CC4
               TabIndex        =   68
               Top             =   120
               Width           =   8385
            End
         ...
         Begin TabDlg.SSTab SSTab9 
            ...
            EndProperty
            TabCaption(0)   =   "IMP"
            TabPicture(0)   =   "frmVtasLocalRubro.frx":81EA
            Tab(0).ControlCount=   1
            Tab(0).ControlEnabled=   -1  'True
            Tab(0).Control(0)=   "SprImp(6)"
            Tab(0).Control(0).Enabled=   0   'False
            TabCaption(1)   =   "UNID"
            TabPicture(1)   =   "frmVtasLocalRubro.frx":8206
            Tab(1).ControlCount=   1
            Tab(1).ControlEnabled=   0   'False
            ...
            Begin FPSpread.vaSpread SprUnid 
               ...
               Index           =   6
               Left            =   -74865
               OleObjectBlob   =   "frmVtasLocalRubro.frx":8222
               TabIndex        =   83
               Top             =   135
               Width           =   8385
            End
            Begin FPSpread.vaSpread SprImp 
               ...
               Index           =   6
               Left            =   150
               OleObjectBlob   =   "frmVtasLocalRubro.frx":8726
               TabIndex        =   69
               Top             =   90
               Width           =   8430
            End
         ...
         Begin TabDlg.SSTab SSTab19 
            ...
            EndProperty
            TabCaption(0)   =   "IMP"
            TabPicture(0)   =   "frmVtasLocalRubro.frx":8C4C
            Tab(0).ControlCount=   1
            Tab(0).ControlEnabled=   -1  'True
            Tab(0).Control(0)=   "SprImp(4)"
            Tab(0).Control(0).Enabled=   0   'False
            TabCaption(1)   =   "UNID"
            TabPicture(1)   =   "frmVtasLocalRubro.frx":8C68
            Tab(1).ControlCount=   1
            Tab(1).ControlEnabled=   0   'False
            ...
            Begin FPSpread.vaSpread SprUnid 
               ...
               Index           =   4
               Left            =   -74880
               OleObjectBlob   =   "frmVtasLocalRubro.frx":8C84
               TabIndex        =   81
               Top             =   120
               Width           =   8415
            End
            Begin FPSpread.vaSpread SprImp 
               ...
               Index           =   4
               Left            =   120
               OleObjectBlob   =   "frmVtasLocalRubro.frx":9188
               TabIndex        =   67
               Top             =   120
               Width           =   8430
            End
      ...
      Begin TabDlg.SSTab TabAep 
         ...
         EndProperty
         TabCaption(0)   =   "RESUMEN"
         TabPicture(0)   =   "frmVtasLocalRubro.frx":96AE
         Tab(0).ControlCount=   1
         Tab(0).ControlEnabled=   0   'False
         Tab(0).Control(0)=   "SSTab10"
         Tab(0).Control(0).Enabled=   0   'False
         TabCaption(1)   =   "L09"
         TabPicture(1)   =   "frmVtasLocalRubro.frx":96CA
         Tab(1).ControlCount=   1
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "SSTab11"
         Tab(1).Control(0).Enabled=   0   'False
         TabCaption(2)   =   "L14"
         TabPicture(2)   =   "frmVtasLocalRubro.frx":96E6
         Tab(2).ControlCount=   1
         ...
         Begin FPSpread.vaSpread SSTab14 
            ...
            Index           =   8
            Left            =   -74505
            OleObjectBlob   =   "frmVtasLocalRubro.frx":9702
            TabIndex        =   30
            Top             =   105
            Width           =   5505
         End
         Begin FPSpread.vaSpread SSTab7 
            ...
            Index           =   7
            Left            =   -74505
            OleObjectBlob   =   "frmVtasLocalRubro.frx":9A59
            TabIndex        =   29
            Top             =   105
            Width           =   5505
         End
         Begin TabDlg.SSTab SSTab10 
            ...
            EndProperty
            TabCaption(0)   =   "IMP"
            TabPicture(0)   =   "frmVtasLocalRubro.frx":9DCC
            Tab(0).ControlCount=   1
            Tab(0).ControlEnabled=   -1  'True
            Tab(0).Control(0)=   "SprImpResumen(2)"
            Tab(0).Control(0).Enabled=   0   'False
            TabCaption(1)   =   "UNID"
            TabPicture(1)   =   "frmVtasLocalRubro.frx":9DE8
            Tab(1).ControlCount=   1
            Tab(1).ControlEnabled=   0   'False
            ...
            Begin FPSpread.vaSpread SprImpResumen 
               ...
               Index           =   2
               Left            =   150
               OleObjectBlob   =   "frmVtasLocalRubro.frx":9E04
               TabIndex        =   57
               Top             =   105
               Width           =   8370
            End
            Begin FPSpread.vaSpread SprUnidResumen 
               ...
               Index           =   2
               Left            =   -74850
               OleObjectBlob   =   "frmVtasLocalRubro.frx":A32A
               TabIndex        =   61
               Top             =   120
               Width           =   8385
            End
         ...
         Begin TabDlg.SSTab SSTab11 
            ...
            EndProperty
            TabCaption(0)   =   "IMP"
            TabPicture(0)   =   "frmVtasLocalRubro.frx":A82E
            Tab(0).ControlCount=   1
            Tab(0).ControlEnabled=   -1  'True
            Tab(0).Control(0)=   "SprImp(7)"
            Tab(0).Control(0).Enabled=   0   'False
            TabCaption(1)   =   "UNID"
            TabPicture(1)   =   "frmVtasLocalRubro.frx":A84A
            Tab(1).ControlCount=   1
            Tab(1).ControlEnabled=   0   'False
            ...
            Begin FPSpread.vaSpread SprUnid 
               ...
               Index           =   7
               Left            =   -74865
               OleObjectBlob   =   "frmVtasLocalRubro.frx":A866
               TabIndex        =   84
               Top             =   120
               Width           =   8385
            End
            Begin FPSpread.vaSpread SprImp 
               ...
               Index           =   7
               Left            =   135
               OleObjectBlob   =   "frmVtasLocalRubro.frx":AD6A
               TabIndex        =   70
               Top             =   120
               Width           =   8400
            End
         ...
         Begin TabDlg.SSTab SSTab12 
            ...
            EndProperty
            TabCaption(0)   =   "IMP"
            TabPicture(0)   =   "frmVtasLocalRubro.frx":B290
            Tab(0).ControlCount=   1
            Tab(0).ControlEnabled=   -1  'True
            Tab(0).Control(0)=   "SprImp(8)"
            Tab(0).Control(0).Enabled=   0   'False
            TabCaption(1)   =   "UNID"
            TabPicture(1)   =   "frmVtasLocalRubro.frx":B2AC
            Tab(1).ControlCount=   1
            Tab(1).ControlEnabled=   0   'False
            ...
            Begin FPSpread.vaSpread SprUnid 
               ...
               Index           =   8
               Left            =   -74895
               OleObjectBlob   =   "frmVtasLocalRubro.frx":B2C8
               TabIndex        =   85
               Top             =   135
               Width           =   8400
            End
            Begin FPSpread.vaSpread SprImp 
               ...
               Index           =   8
               Left            =   150
               OleObjectBlob   =   "frmVtasLocalRubro.frx":B7CC
               TabIndex        =   71
               Top             =   150
               Width           =   8400
            End
      ...
      Begin TabDlg.SSTab TabInterior 
         ...
         EndProperty
         TabCaption(0)   =   "RESUMEN"
         TabPicture(0)   =   "frmVtasLocalRubro.frx":BCF2
         Tab(0).ControlCount=   1
         Tab(0).ControlEnabled=   0   'False
         Tab(0).Control(0)=   "SSTab13"
         Tab(0).Control(0).Enabled=   0   'False
         TabCaption(1)   =   "L04"
         TabPicture(1)   =   "frmVtasLocalRubro.frx":BD0E
         Tab(1).ControlCount=   1
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "SSTab20"
         Tab(1).Control(0).Enabled=   0   'False
         TabCaption(2)   =   "L10"
         TabPicture(2)   =   "frmVtasLocalRubro.frx":BD2A
         Tab(2).ControlCount=   1
         Tab(2).ControlEnabled=   0   'False
         Tab(2).Control(0)=   "SSTab15"
         Tab(2).Control(0).Enabled=   0   'False
         TabCaption(3)   =   "L15"
         TabPicture(3)   =   "frmVtasLocalRubro.frx":BD46
         Tab(3).ControlCount=   1
         Tab(3).ControlEnabled=   0   'False
         Tab(3).Control(0)=   "SSTab16"
         Tab(3).Control(0).Enabled=   0   'False
         TabCaption(4)   =   "L16"
         TabPicture(4)   =   "frmVtasLocalRubro.frx":BD62
         Tab(4).ControlCount=   1
         Tab(4).ControlEnabled=   0   'False
         Tab(4).Control(0)=   "SSTab17"
         Tab(4).Control(0).Enabled=   0   'False
         TabCaption(5)   =   "L18"
         TabPicture(5)   =   "frmVtasLocalRubro.frx":BD7E
         Tab(5).ControlCount=   1
         Tab(5).ControlEnabled=   0   'False
         Tab(5).Control(0)=   "SSTab18"
         Tab(5).Control(0).Enabled=   0   'False
         TabCaption(6)   =   "L19"
         TabPicture(6)   =   "frmVtasLocalRubro.frx":BD9A
         Tab(6).ControlCount=   1
         Tab(6).ControlEnabled=   -1  'True
         Tab(6).Control(0)=   "SSTab21"
         Tab(6).Control(0).Enabled=   0   'False
         Begin FPSpread.vaSpread SSTab14 
            Height          =   2400
            Index           =   11
            Left            =   -74490
            OleObjectBlob   =   "frmVtasLocalRubro.frx":BDB6
            TabIndex        =   33
            Top             =   105
            Width           =   5505
         End
         Begin FPSpread.vaSpread SSTab7 
            ...
            Index           =   10
            Left            =   -74505
            OleObjectBlob   =   "frmVtasLocalRubro.frx":C10D
            TabIndex        =   32
            Top             =   105
            Width           =   5505
         End
         Begin TabDlg.SSTab SSTab13 
            ...
            EndProperty
            TabCaption(0)   =   "IMP"
            TabPicture(0)   =   "frmVtasLocalRubro.frx":C480
            Tab(0).ControlCount=   1
            Tab(0).ControlEnabled=   -1  'True
            Tab(0).Control(0)=   "SprImpResumen(3)"
            Tab(0).Control(0).Enabled=   0   'False
            TabCaption(1)   =   "UNID"
            TabPicture(1)   =   "frmVtasLocalRubro.frx":C49C
            Tab(1).ControlCount=   1
            Tab(1).ControlEnabled=   0   'False
            ...
            Begin FPSpread.vaSpread SprImpResumen 
               ...
               Index           =   3
               Left            =   120
               OleObjectBlob   =   "frmVtasLocalRubro.frx":C4B8
               TabIndex        =   58
               Top             =   120
               Width           =   8430
            End
            Begin FPSpread.vaSpread SprUnidResumen 
               ...
               Index           =   3
               Left            =   -74865
               OleObjectBlob   =   "frmVtasLocalRubro.frx":C9DE
               TabIndex        =   62
               Top             =   135
               Width           =   8385
            End
         ...
         Begin TabDlg.SSTab SSTab15 
            ...
            EndProperty
            TabCaption(0)   =   "IMP"
            TabPicture(0)   =   "frmVtasLocalRubro.frx":CEE2
            Tab(0).ControlCount=   1
            Tab(0).ControlEnabled=   -1  'True
            Tab(0).Control(0)=   "SprImp(10)"
            Tab(0).Control(0).Enabled=   0   'False
            TabCaption(1)   =   "UNID"
            TabPicture(1)   =   "frmVtasLocalRubro.frx":CEFE
            Tab(1).ControlCount=   1
            Tab(1).ControlEnabled=   0   'False
            ...
            Begin FPSpread.vaSpread SprUnid 
               ...
               Index           =   10
               Left            =   -74880
               OleObjectBlob   =   "frmVtasLocalRubro.frx":CF1A
               TabIndex        =   87
               Top             =   120
               Width           =   8430
            End
            Begin FPSpread.vaSpread SprImp 
               ...
               Index           =   10
               Left            =   105
               OleObjectBlob   =   "frmVtasLocalRubro.frx":D41E
               TabIndex        =   73
               Top             =   105
               Width           =   8430
            End
         ...
         Begin TabDlg.SSTab SSTab16 
            ...
            EndProperty
            TabCaption(0)   =   "IMP"
            TabPicture(0)   =   "frmVtasLocalRubro.frx":D944
            Tab(0).ControlCount=   1
            Tab(0).ControlEnabled=   -1  'True
            Tab(0).Control(0)=   "SprImp(11)"
            Tab(0).Control(0).Enabled=   0   'False
            TabCaption(1)   =   "UNID"
            TabPicture(1)   =   "frmVtasLocalRubro.frx":D960
            Tab(1).ControlCount=   1
            Tab(1).ControlEnabled=   0   'False
            ...
            Begin FPSpread.vaSpread SprUnid 
               ...
               Index           =   11
               Left            =   -74880
               OleObjectBlob   =   "frmVtasLocalRubro.frx":D97C
               TabIndex        =   88
               Top             =   120
               Width           =   8385
            End
            Begin FPSpread.vaSpread SprImp 
               ...
               Index           =   11
               Left            =   120
               OleObjectBlob   =   "frmVtasLocalRubro.frx":DE80
               TabIndex        =   74
               Top             =   105
               Width           =   8415
            End
         ...
         Begin TabDlg.SSTab SSTab17 
            ...
            EndProperty
            TabCaption(0)   =   "IMP"
            TabPicture(0)   =   "frmVtasLocalRubro.frx":E3A6
            Tab(0).ControlCount=   1
            Tab(0).ControlEnabled=   -1  'True
            Tab(0).Control(0)=   "SprImp(12)"
            Tab(0).Control(0).Enabled=   0   'False
            TabCaption(1)   =   "UNID"
            TabPicture(1)   =   "frmVtasLocalRubro.frx":E3C2
            Tab(1).ControlCount=   1
            Tab(1).ControlEnabled=   0   'False
            ...
            Begin FPSpread.vaSpread SprUnid 
               ...
               Index           =   12
               Left            =   -74895
               OleObjectBlob   =   "frmVtasLocalRubro.frx":E3DE
               TabIndex        =   89
               Top             =   120
               Width           =   8430
            End
            Begin FPSpread.vaSpread SprImp 
               ...
               Index           =   12
               Left            =   120
               OleObjectBlob   =   "frmVtasLocalRubro.frx":E8E2
               TabIndex        =   75
               Top             =   105
               Width           =   8430
            End
         ...
         Begin TabDlg.SSTab SSTab18 
            ...
            EndProperty
            TabCaption(0)   =   "IMP"
            TabPicture(0)   =   "frmVtasLocalRubro.frx":EE08
            Tab(0).ControlCount=   1
            Tab(0).ControlEnabled=   -1  'True
            Tab(0).Control(0)=   "SprImp(13)"
            Tab(0).Control(0).Enabled=   0   'False
            TabCaption(1)   =   "UNID"
            TabPicture(1)   =   "frmVtasLocalRubro.frx":EE24
            Tab(1).ControlCount=   1
            Tab(1).ControlEnabled=   0   'False
            ...
            Begin FPSpread.vaSpread SprUnid 
               ...
               Index           =   13
               Left            =   -74880
               OleObjectBlob   =   "frmVtasLocalRubro.frx":EE40
               TabIndex        =   90
               Top             =   120
               Width           =   8430
            End
            Begin FPSpread.vaSpread SprImp 
               ...
               Index           =   13
               Left            =   135
               OleObjectBlob   =   "frmVtasLocalRubro.frx":F344
               TabIndex        =   76
               Top             =   120
               Width           =   8400
            End
         ...
         Begin TabDlg.SSTab SSTab20 
            ...
            EndProperty
            TabCaption(0)   =   "IMP"
            TabPicture(0)   =   "frmVtasLocalRubro.frx":F86A
            Tab(0).ControlCount=   1
            Tab(0).ControlEnabled=   -1  'True
            Tab(0).Control(0)=   "SprImp(9)"
            Tab(0).Control(0).Enabled=   0   'False
            TabCaption(1)   =   "UNID"
            TabPicture(1)   =   "frmVtasLocalRubro.frx":F886
            Tab(1).ControlCount=   1
            Tab(1).ControlEnabled=   0   'False
            ...
            Begin FPSpread.vaSpread SprUnid 
               ...
               Index           =   9
               Left            =   -74895
               OleObjectBlob   =   "frmVtasLocalRubro.frx":F8A2
               TabIndex        =   86
               Top             =   120
               Width           =   8445
            End
            Begin FPSpread.vaSpread SprImp 
               ...
               Index           =   9
               Left            =   105
               OleObjectBlob   =   "frmVtasLocalRubro.frx":FD52
               TabIndex        =   72
               Top             =   105
               Width           =   8430
            End
         End
         Begin TabDlg.SSTab SSTab21 
            Height          =   3420
            Left            =   105
            TabIndex        =   91
            Top             =   135
            ...
            EndProperty
            TabCaption(0)   =   "IMP"
            TabPicture(0)   =   "frmVtasLocalRubro.frx":10278
            Tab(0).ControlCount=   1
            Tab(0).ControlEnabled=   -1  'True
            Tab(0).Control(0)=   "SprImp(14)"
            Tab(0).Control(0).Enabled=   0   'False
            TabCaption(1)   =   "UNID"
            TabPicture(1)   =   "frmVtasLocalRubro.frx":10294
            Tab(1).ControlCount=   1
            Tab(1).ControlEnabled=   0   'False
            Tab(1).Control(0)=   "SprUnid(15)"
            Tab(1).Control(0).Enabled=   0   'False
            Begin FPSpread.vaSpread SprUnid 
               Height          =   3150
               Index           =   15
               Left            =   -74880
               OleObjectBlob   =   "frmVtasLocalRubro.frx":102B0
               TabIndex        =   94
               Top             =   120
               Width           =   8430
            End
            Begin FPSpread.vaSpread SprImp 
               ...
               Index           =   14
               Left            =   120
               OleObjectBlob   =   "frmVtasLocalRubro.frx":107B4
               TabIndex        =   93
               Top             =   120
               Width           =   8400
            End
            Begin FPSpread.vaSpread SprUnid 
               ...
               Index           =   14
               Left            =   -74880
               OleObjectBlob   =   "frmVtasLocalRubro.frx":10CDA
               TabIndex        =   92
               Top             =   120
               Width           =   8430
            End
      ...
      Begin TabDlg.SSTab tabTotal 
         ...
         TabPicture(0)   =   "frmVtasLocalRubro.frx":111DE
         Tab(0).ControlCount=   1
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "SprImpTotal"
         Tab(0).Control(0).Enabled=   0   'False
         TabCaption(1)   =   "Unidades"
         TabPicture(1)   =   "frmVtasLocalRubro.frx":111FA
         Tab(1).ControlCount=   1
         Tab(1).ControlEnabled=   0   'False
         ...
         Begin FPSpread.vaSpread SprImpTotal 
            Height          =   3150
            Left            =   120
            OleObjectBlob   =   "frmVtasLocalRubro.frx":11216
            TabIndex        =   46
            Top             =   150
            Width           =   8340
         End
         Begin FPSpread.vaSpread SprUnidTotal 
            Height          =   3180
            Left            =   -74880
            OleObjectBlob   =   "frmVtasLocalRubro.frx":1173C
            TabIndex        =   52
            Top             =   120
            Width           =   8355
         End
...
Dim locales(0 To 14) As String
Dim totCordAct(10) As Single, totCordAnt(10) As Single
Dim totMendAct(10) As Single, totMendAnt(10) As Single
Private Sub L_LlenaResDiferencias()
Dim valor As Variant
Dim i As Integer

For i = 1 To SprImpResumen(0).MaxRows - 1
    SprImp(0).GetText 7, i, valor 'L05
    sprResDif.SetText 2, i, valor
    
    SprImp(1).GetText 7, i, valor 'L06
    sprResDif.SetText 3, i, valor
    
    SprImp(2).GetText 7, i, valor 'L07
    sprResDif.SetText 4, i, valor
    
    SprImp(3).GetText 7, i, valor 'L08
    sprResDif.SetText 5, i, valor
    
    SprImpResumen(0).GetText 7, i, valor 'EZEA
    sprResDif.SetText 6, i, valor
    
    SprImp(4).GetText 7, i, valor 'L01
    sprResDif.SetText 7, i, valor
    
    SprImp(5).GetText 7, i, valor 'L02
    sprResDif.SetText 8, i, valor
    
    SprImp(6).GetText 7, i, valor 'L03
    sprResDif.SetText 9, i, valor
    
    SprImpResumen(1).GetText 7, i, valor 'EZEB
    sprResDif.SetText 10, i, valor
    
    SprImp(7).GetText 7, i, valor 'L09
    sprResDif.SetText 11, i, valor
    
    SprImp(8).GetText 7, i, valor 'L14
    sprResDif.SetText 12, i, valor
    
    SprImpResumen(2).GetText 7, i, valor 'AEP
    sprResDif.SetText 13, i, valor
    
    SprImp(9).GetText 7, i, valor 'L04
    sprResDif.SetText 14, i, valor
    
    SprImp(14).GetText 7, i, valor 'L19
    sprResDif.SetText 15, i, valor
    If totCordAnt(0) > 0 And totCordAct(0) > 0 And totCordAnt(i) > 0 Then
    sprResDif.SetText 16, i, ((totCordAct(i) / totCordAct(0)) - (totCordAnt(i) / totCordAnt(0))) / (totCordAnt(i) / totCordAnt(0)) * 100
    End If
    
    SprImp(10).GetText 7, i, valor 'L10
    sprResDif.SetText 17, i, valor
    
    SprImp(12).GetText 7, i, valor 'L16
    sprResDif.SetText 18, i, valor
    If totMendAnt(0) > 0 And totMendAct(0) > 0 And totMendAnt(i) > 0 Then
    sprResDif.SetText 19, i, ((totMendAct(i) / totMendAct(0)) - (totMendAnt(i) / totMendAnt(0))) / (totMendAnt(i) / totMendAnt(0)) * 100
    End If
    
    SprImp(11).GetText 7, i, valor 'L15
    sprResDif.SetText 20, i, valor
    
    SprImp(13).GetText 7, i, valor 'L18
    sprResDif.SetText 21, i, valor
    
    SprImpResumen(3).GetText 7, i, valor 'INT
    sprResDif.SetText 22, i, valor
...
End Select
     ...
     Cond = Cond & " And cod_local <> 'L11' And cod_rubr <> 'REG' "
...
If Aplicacion.ObtenerRsDAO(sqlL, RsDataLoc) Then
   If Aplicacion.CantReg(RsData) > 0 Then
      ...
      Do While Not RsDataLoc.EOF
            ...
            sprResDif.MaxRows = sprResDif.MaxRows + 1
            sprResDif.SetText 1, SprImpTotal.MaxRows, Trim(RsDataLoc!cod_rubr)
...
'Consulta Actual
sql = " Select cod_depn,cod_sdep, decode(cod_local,'L21', decode(cod_sloc,0,'L05','L06'),'L07','L22',cod_local)  cod_local,cod_rubr,"
...
sql = sql & " group by cod_depn,cod_sdep, decode(cod_local,'L21', decode(cod_sloc,0,'L05','L06'),'L07','L22',cod_local) ,cod_rubr "
sql = sql & " order by cod_depn,cod_sdep,cod_local,cod_rubr "


'Consulta Anterior
sqlX = " Select cod_depn,cod_sdep, decode(cod_local,'L21', decode(cod_sloc,0,'L05','L06'),'L07','L22',cod_local) cod_local ,cod_rubr "
...
sqlX = sqlX & " group by cod_depn,cod_sdep, decode(cod_local,'L21', decode(cod_sloc,0,'L05','L06'),'L07','L22',cod_local) ,cod_rubr "
...
Dim fila As Integer, Col As Long
Dim i As Integer
...
For fila = 1 To sprResDif.MaxRows
   For Col = 2 To 22
   Spread.spread_ResaltarCelda sprResDif, Col, fila
   Next
Next
...
For i = 0 To 14
   ...
   If i = 9 Or i = 14 Then
        totCordAct(0) = totCordAct(0) + Total
        totCordAnt(0) = totCordAnt(0) + TotalANT
   End If
   If i = 10 Or i = 12 Then
        totMendAct(0) = totMendAct(0) + Total
        totMendAnt(0) = totMendAnt(0) + TotalANT
   End If
   ...
   For fila = 1 To SprImpTotal.MaxRows - 1
       ...
       If i = 9 Or i = 14 Then
         totCordAct(fila) = totCordAct(fila) + valor
         totCordAnt(fila) = totCordAnt(fila) + ValorAnt
       End If
       If i = 10 Or i = 12 Then
         totMendAct(fila) = totMendAct(fila) + valor
         totMendAnt(fila) = totMendAnt(fila) + ValorAnt
       End If
